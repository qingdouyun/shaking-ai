      ...
      >
        {
          dataSource.goods.length>0?
            dataSource.goods.map((item, index) => {
              return (
                <Col key={index} span={12} className={styles.item} style={{flex:'0 0 49%',marginBottom:'10px',borderRadius: `${dataSource.borderRadius}px`}} onClick={()=>{history.push('/goods/detail/' + item.key);}}>
