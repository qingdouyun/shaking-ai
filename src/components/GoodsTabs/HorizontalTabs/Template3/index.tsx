      ...
      >
        {
          dataSource.goods.length>0?
            dataSource.goods.map((item, index) => {
              return (
                <Col key={index} span={8} className="temp3-list" style={{flex:'0 0 32%',padding:'0',display:'block',marginBottom:'10px'}} onClick={()=>{history.push('/goods/detail/' + item.key);}}>
                  ...
                  >
                    <p 
                      ...
                      style={{
                        lineHeight:'30px',paddingBottom:'5px',height:'30px',textAlign:'left',
